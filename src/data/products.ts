...
export const PRODUCTS: Product[] = [
  ...
  {
    id: 'chaqueta-led-urban',
    name: 'Chaqueta LED Urban',
    price: 129.99,
    description: 'Techwear impermeable con tiras LED integradas controlables por app. Estilo que se enciende.',
    category: 'Moda Urbana',
    badge: 'Trending',
    image: '/products/led-jacket.jpg',
    images: [
    '/products/smart-glasses.jpg',
    '/products/smart-glasses-2.jpg',
    '/products/smart-glasses-3.jpg',
